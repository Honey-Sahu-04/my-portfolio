...
const projects = [
  {
    ...
    period: "Apr 2025",
    desc: "Created an ML-based chatbot to detect user sentiment and provide supportive mental health responses using NLP techniques and interactive UI.",
    highlights: ["Sentiment detection with ML classification", "NLP text preprocessing with NLTK", "Interactive Streamlit web interface", "Mental health response generation"],
    tech: ["Python", "Pandas", "Scikit-learn", "NLTK", "Streamlit", "Jupyter Notebook"],
    badge: "ML Project",
    icon: "🤖",
    link: "https://github.com/Honey-Sahu-04/Sentiment-Analysis-using-LR",
    live: null,
  },
  {
    title: "Spam SMS Classifier using ML",
    period: "Jul 2025",
    desc: "Developed a machine learning system to classify SMS messages as spam or ham using NLP preprocessing and Random Forest classification.",
    highlights: ["Text preprocessing & feature extraction", "Random Forest classification model", "NLP pipeline with NLTK", "High accuracy spam detection"],
    tech: ["Python", "Pandas", "NumPy", "Scikit-learn", "NLTK"],
    badge: "ML Project",
    icon: "📱",
    link: "https://github.com/Honey-Sahu-04/Spam-SMS-classifier-using-Random-Forest",
    live: null,
  },
  {
    title: "Noise Pollution Zone Clustering",
    period: "Nov 2025",
    desc: "K-Means clustering on CPCB datasets to identify noise pollution zones for city planning, with data visualization and analysis.",
    highlights: ["K-Means clustering algorithm", "CPCB dataset analysis", "Zone identification for city planning", "Data visualization with Matplotlib"],
    tech: ["Python", "Pandas", "NumPy", "NLTK", "Scikit-learn", "Matplotlib"],
    badge: "ML Project",
    icon: "🏙️",
    link: "https://github.com/Honey-Sahu-04/Noise-Pollution-Zone-Clustering-for-City-Planning-using-ML",
    live: null,
  },
];
    ...
    <section id="projects" className="py-28 px-6" ref={ref}>
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div initial={{opacity:0}} animate={inView?{opacity:1}:{}} transition={{delay:0.7}} className="text-center mt-10">
          <a href="https://github.com/Honey-Sahu-04" target="_blank" rel="noopener noreferrer"
