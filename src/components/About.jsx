        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              with a CGPA of <span className="text-orange-400 font-semibold">8.13</span>.
            </motion.p>
            ...
            >
              ...
              <span className="text-orange-400 font-semibold">Machine Learning</span> — building
              intelligent applications using Python, Scikit-learn, and NLP. I've built real-world
              projects including a Sentiment Analysis Chatbot, Spam SMS Classifier, and Noise Pollution
              Zone Clustering system.
            </motion.p>
          ...
          >
            {[
              ...
              },
              {
                ...
                label: "Email",
                value: "honey3.sahu@gmail.com",
                href: "mailto:honey3.sahu@gmail.com",
              },
              // {
              //   icon: (
              //     <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              // },
              {
                ...
                label: "GitHub",
                value: "github.com/Honey-Sahu-04",
                href: "https://github.com/Honey-Sahu-04",
              },
              {
                icon: (
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                label: "LinkedIn",
                value: "linkedin.com/in/honeysahu",
                href: "https://www.linkedin.com/in/honeysahu/",
              },
            ].map((item, i) => (
              <motion.div
                key={item.label}
