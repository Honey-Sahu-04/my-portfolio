...
const roles = ["Machine Learning Engineer", "Data Science Enthusiast", "Problem Solver"];
        ...
        <div className="flex justify-center items-center w-full">
          ...
          <motion.div variants={container} initial="hidden" animate="show" className="flex flex-col items-center text-center">
            ...
            <motion.h1 variants={item} className="text-5xl sm:text-6xl md:text-7xl font-black mb-3 leading-none tracking-tight font-display">
              Honey<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400   to-orange-600">Sahu</span>
            </motion.h1>
            ...
            <motion.p variants={item} className="text-gray-500 mt-4 mb-8 text-sm leading-relaxed max-w-md text-center">
              B.Tech CSE @ Lovely Professional University · <span className="text-orange-400 font-semibold">Machine Learning Engineer </span>· Building
              intelligent solutions with Python, Scikit-learn and NLTK.
            </motion.p>
            ...
            <motion.div variants={item} className="flex justify-center gap-5 mt-8">
              {[
                { label: "GitHub", href: "https://github.com/Honey-Sahu-04" },
                { label: "LinkedIn", href: "https://www.linkedin.com/in/honeysahu/" },
              ].map((s) => (
          ...
          {/* <div className="w-full h-full items-center justify-center text-center px-6 hidden" style={{display:'none'}}>
                  ...
                  <div className="text-white font-bold">Honey Sahu</div>
                  <div className="text-orange-400 text-xs mt-1">Machine Learning Engineer</div>
                </div> */}
          {/* Overlay gradient at bottom */}
          {/* <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#0a0a0a] to-transparent" />
                <div className="absolute bottom-4 left-0 right-0 text-center">
                  <div className="text-white font-bold text-sm">Honey Sahu</div>
                  <div className="text-orange-400 text-xs">Machine Learning Engineer</div>
                </div>
              </div> */}
          {/* Floating badge */}
          {/* <motion.div
              ...
              >
                ...
                <div className="text-orange-400 font-black text-lg">8.13</div>
              </motion.div> */}
          {/* <motion.div
                animate={{ y: [0, 6, 0] }}
          ...
          {/* <div className="text-xs text-gray-400">Experience</div>
                <div className="text-orange-400 font-black text-lg">ML</div> */}
          {/* </motion.div>
            </div>
          </motion.div> */}
        </div>
